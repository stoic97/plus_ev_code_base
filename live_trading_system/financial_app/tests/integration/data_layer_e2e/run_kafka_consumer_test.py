...
def patch_imports_with_mocks():
    ...
    from financial_app.tests.integration.data_layer_e2e.mock_kafka import (
...
def setup_mock_data():
    ...
    try:
        ...
        from financial_app.tests.integration.data_layer_e2e.mock_kafka import publish_mock_market_data
...
def run_kafka_consumer_tests():
    ...
    try:
        ...
        from financial_app.tests.integration.data_layer_e2e.test_kafka_consumer import KafkaConsumerTest
